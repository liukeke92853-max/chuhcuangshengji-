const reference = 'assets/reference.png';
...
function productTemplate(p) {
  ...
  return `<article class="product-card" data-id="${p.id}">
    ...
    <div class="product-main">
      <span class="crop product-image img-${p.image}"><img src="${reference}" alt="${p.title}" /></span>
    ...
    <div class="card-actions">
      <span class="creator"><span class="crop avatar"><img src="${reference}" alt="" /></span><span>热心宇宙人</span><i>·</i><em>${linkText}</em></span>
